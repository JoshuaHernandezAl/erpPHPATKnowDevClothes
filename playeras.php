...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-8">
            <h3 class="fw-blod fs-2 ">Playeras:</h3>
            <table class="table table-primary table-striped mt-5">
                ...
                <tbody>
                    <?php 
                        $playeras=listarTodasPlayeras($db);
                        if(!empty($playeras)):
                            foreach($playeras as $playera):                            
                    ?>
                        <tr>
                            <th scope="row"><?=$playera['id']?></th>
                            <td><?=$playera['modelo']?></td>
                            <td><?=$playera['precio']?></td>
                            <td><?=$playera['talla']?></td>
                            <td><?=$playera['color']?></td>
                            <td><img src="./files/playeras/<?=$playera['imagen']?>" width="75px" height="60px"/></td>
                            <td><?=$playera['stock']?></td>
                            <td><?=$playera['disponible']?></td>
                            <td><button class="btn btn-primary btn-lg "><a href="editar.php?categoria=playeras&id=<?=$playera['id']?>" class="link-light fw-bold">Editar</a></button></td>
                            <td><button class="btn btn-danger btn-lg "><a href="eliminar.php?categoria=playeras&id=<?=$playera['id']?>" class="link-light fw-bold">Eliminar</a></button></td>
                        </tr>
                    <?php 
                            endforeach;
                        endif;
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><button class="btn btn-primary btn-lg "><a href="editar.php?categoria=playeras&id=<?=$producto['id']?>" class="link-light fw-bold">Editar</a></button></td>
                        <td><button class="btn btn-danger btn-lg "><a href="editar.php?categoria=playeras&id=<?=$producto['id']?>" class="link-light fw-bold">Eliminar</a></button></td>
                    </tr>
                <?php 
                    endfor;
                ?>
