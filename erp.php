            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><button class="btn btn-primary btn-lg "><a href="editar.php?categoria=<?=$_SESSION['producto']['categoria']?>&id=<?=$producto['id']?>" class="link-light fw-bold">Editar</a></button></td>
                        <td><button class="btn btn-danger btn-lg "><a href="editar.php?categoria=<?=$_SESSION['producto']['categoria']?>&id=<?=$producto['id']?>" class="link-light fw-bold">Eliminar</a></button></td>
                    </tr>
                <?php 
                    endfor;
                ?>
